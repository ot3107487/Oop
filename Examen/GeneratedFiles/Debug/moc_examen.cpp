...
struct qt_meta_stringdata_Examen_t {
    QByteArrayData data[1];
    char stringdata0[7];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Examen_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Examen_t qt_meta_stringdata_Examen = {
    {
QT_MOC_LITERAL(0, 0, 6) // "Examen"
...
const QMetaObject Examen::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Examen.data,
      qt_meta_data_Examen,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Examen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Examen.stringdata0))
