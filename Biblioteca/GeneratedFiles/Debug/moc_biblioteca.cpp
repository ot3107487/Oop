...
const QMetaObject Biblioteca::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Biblioteca.data,
      qt_meta_data_Biblioteca,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Biblioteca::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Biblioteca.stringdata0))
        return static_cast<void*>(const_cast< Biblioteca*>(this));
