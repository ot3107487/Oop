...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_magazin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_magazin_t qt_meta_stringdata_magazin = {
    {
QT_MOC_LITERAL(0, 0, 7) // "magazin"
...
static const uint qt_meta_data_magazin[] = {
...
const QMetaObject magazin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_magazin.data,
      qt_meta_data_magazin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *magazin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_magazin.stringdata0))
        return static_cast<void*>(const_cast< magazin*>(this));
